...
import springboot.model.vo.CommentVo;
import springboot.model.vo.ContentVo;
...
public class Commons {
     ...
     public static String THEME = "themes/ahazww";
...
//        gravatar地址
    ...
    public static String show_categories(String categories) throws UnsupportedEncodingException {
        if (StringUtils.isNotBlank(categories)) {
            ...
            for (String c : arr) {
                sbuf.append("<assets class=\"blog-color\" href=\"/category/" + URLEncoder.encode(c, "UTF-8") + "\">" + c + "</assets>");
            }
    ...
    public static String show_tags(String tags) throws UnsupportedEncodingException {
        if (StringUtils.isNotBlank(tags)) {
            ...
            StringBuffer sbuf = new StringBuffer();
            for (String c : arr) {
                sbuf.append("<assets href=\"/tag/" + URLEncoder.encode(c, "UTF-8") + "\">" + c + "</assets>");
            }
            return sbuf.toString();
        }
        return "";
    ...
    public static String comment_at(Integer coid) {
        ...
        if (null != comments) {
            return "<assets href=\"#comment-" + coid + "\">@" + comments.getAuthor() + "</assets>";
        }
        return "";
    }

    /**
     * An :grinning:awesome :smiley:string &#128516;with assets few :wink:emojis!
     * <p>
     * 这种格式的字符转换为emoji表情
     *
     * @param value
