...
-- 创建数据库
create database `ahazww` default character set utf8 collate utf8_general_ci;
...
VALUES
	(1, 'admin', 'a66abb5684c45962d887564f08346e8d', 'ahazww@qq.com', NULL, 'admin', 1490756162, 0, 0, 'visitor');