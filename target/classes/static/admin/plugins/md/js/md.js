function markdown(textarea, toolbar, preview) {
    ...
    // 编辑预览切换
    var edittab = $('#md-button-bar').prepend('<div class="md-edittab"><assets href="#md-editarea" class="active">撰写</assets><assets href="#md-preview">预览</assets></div>'),
        editarea = $(textarea.parent()).attr("id", "md-editarea");

    $(".md-edittab assets").click(function() {
        $(".md-edittab assets").removeClass('active');
